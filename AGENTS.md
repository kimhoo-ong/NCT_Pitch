# AGENTS.md — NCT Feasibility Simulator

> Operational guide for Codex working on this project. Read this first before writing any code.
...
This `AGENTS.md` covers: conventions, project structure, gotchas, workflow with the human.
